       ...
       Column{
            ...
            Row{
                ...
                Boton{
                    ...
                    onClicking: {
                        ...
                        var c='{"arg0":"-folder='+appsDir+'/unik-slg", "arg1":"-dir='+appsDir+'/unik-slg", "arg2":"-cfg"}'
                        unik.setFile(j, c)
                        ...
                        code+='     Xdc{\n'
                        code+='     consulta: "Se ha reconfigurado unik-slg\\nPara cargar la \\nnueva configuraciòn\\nes necesario reiniciar la aplicaciòn.\\n\\n¿Desea reiniciar ahora?"\n'
                        code+='     code: '+ncode+'\n'
                        code+='}\n'
                        code+='}\n'
            ...
            Row{
                ...
                Boton{
                    ...
                    onClicking: {
                        var j=appsDir+'/cfg.json'
                        var c='{"arg0":"-git=https://github.com/nextsigner/unik-slg.git", "arg1":"-dir='+appsDir+'/unik-slg", "arg2":"-cfg"}'
                        unik.setFile(j, c)
                        unik.restartApp("-cfg")
                    }
                    Text {
